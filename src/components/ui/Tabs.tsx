...
const ListItem: React.FC<{
  ...
  return (
    <Link
      ...
      } flex  border items-center justify-center gap-2 max-w-[7rem] rounded-full cursor-pointer px-3 py-2 text-secondary hover:bg-blue-600 hover:border-blue-600 hover:text-white dark:hover:border-blue-600 transition-all duration-300 ease-in-out`}
    >
      {props.title}
    </Link>
  );
